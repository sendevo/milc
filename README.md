...
- `audio_list` — one or more audio players
...
Multiple answers recorded for the same scenario on the same app-use day are treated as a single effective observation for PEC purposes, so duplicate same-day entries cannot artificially inflate the numerator.
...
where PEC is a proportion between 0 and 1, and severity is 1, 2, or 3. The result stays in the range 0 to 1, where 0 means no risk and 1 means maximum risk.

This yields the following guide-consistent maxima:
...
├── telemetry
│   └── telemetryQueue.js
├── theme                                 # Theme bootstrap/helpers
│   ├── BarChart.styles.js
│   ├── ButtonsContainer.styles.js
│   ├── Calendar.styles.js
│   ├── CaptchaDialog.styles.js
│   ├── Config.styles.js
│   ├── DairyBarChart.styles.js
│   ├── DateTime.styles.js
│   ├── FormCard.styles.js
│   ├── Info.styles.js
│   ├── Login.styles.js
│   ├── MenuCircle.styles.js
│   ├── Menus.styles.js
│   ├── MilkBarChart.styles.js
│   ├── muiTheme.js
│   ├── Profile.styles.js
│   ├── ProtectedRoute.styles.js
│   ├── Register.styles.js
│   ├── ResultScales.styles.js
│   ├── survey                              # Style modules for survey field components
│   │   ├── AlertBlock.styles.js
│   │   ├── AudioList.styles.js
│   │   ├── BottomNavigation.styles.js
│   │   ├── DatePicker.styles.js
│   │   ├── ImageList.styles.js
│   │   ├── MonthPicker.styles.js
│   │   ├── NumberInput.styles.js
│   │   ├── Select.styles.js
│   │   └── TextBlock.styles.js
│   ├── SurveyStep.styles.js
│   ├── ViewContainer.styles.js
│   └── Welcome.styles.js
...
Capacitor is configured with `webDir: dist` and native Android project output in `android/`.
...
If you update Capacitor plugins, run:
...
- Edit all supported field types (`select`, `number_input`, `alert`, `image_list`, `audio_list`, `text_block`, `month_picker`, `bottom_navigation`)
- Reorder view content blocks with up/down controls (for example image and audio order)
