...
- Name: survey.spec.js >> Survey — before milking flow >> renders the cleaned-space question
- Location: e2e/survey.spec.js:24:5
...
Locator: getByText(/have you cleaned the space/i)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/have you cleaned the space/i)
