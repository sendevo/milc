...
- Name: survey.spec.js >> Survey — before milking flow >> back button returns to the previous page
- Location: e2e/survey.spec.js:51:5
...
Call log:
  - waiting for locator('button:has(svg[data-testid="ArrowBackIosNewIcon"])')
