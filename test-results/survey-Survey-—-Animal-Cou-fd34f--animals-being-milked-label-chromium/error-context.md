...
- Name: survey.spec.js >> Survey — Animal Count step >> renders the number-of-animals-being-milked label
- Location: e2e/survey.spec.js:68:5
...
Locator: getByText(/number of animals being milked/i)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/number of animals being milked/i)
